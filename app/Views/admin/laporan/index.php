...
<div class="row mb-4">
    ...
    <div class="col text-end">
        <a href="<?= base_url('admin/report/export-pdf?tanggal_mulai=' . $tanggal_mulai . '&tanggal_akhir=' . $tanggal_akhir) ?>" target="_blank" class="btn btn-sm btn-outline-primary">
            <i class="fas fa-print me-1"></i>Print PDF
        </a>
        <a href="<?= base_url('admin/report/export-excel?tanggal_mulai=' . $tanggal_mulai . '&tanggal_akhir=' . $tanggal_akhir) ?>" class="btn btn-sm btn-outline-success">
