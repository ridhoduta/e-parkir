...
<form method="post" action="<?= base_url('admin/members/update/'.$member['id']) ?>">
    ...
    <div class="mb-3 position-relative">
        ...
        <input type="text" id="plat_input" name="plat_nomor" class="form-control" autocomplete="off" placeholder="Ketik plat nomor..." value="<?= old('plat_nomor') ?: $member['plat_nomor'] ?>" required>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            platInput.addEventListener('input', function() {
                ...
                if (matches.length > 0) {
                    ...
                    suggestions.innerHTML = '<div class="list-group-item text-muted">Tidak ditemukan kendaraan yang cocok</div>';
                    suggestions.style.display = 'block';
                }
            });
