...
class ReportController extends BaseController
{
    ...
    public function exportPdf()
    {
        ...
        $tanggal_mulai = $this->request->getGet('tanggal_mulai') ?? date('Y-m-d');
        $tanggal_akhir = $this->request->getGet('tanggal_akhir') ?? date('Y-m-d');
        $tipe_laporan = $this->request->getGet('tipe') ?? 'harian'; // harian, rentang, occupancy
        ...
        helper('log');
        \save_log('EXPORT_REPORT', 'Export laporan PDF rentang ' . $tanggal_mulai . ' s/d ' . $tanggal_akhir);
    ...
    public function exportExcel()
    {
        ...
        helper('log');
        \save_log('EXPORT_REPORT', 'Export laporan Excel rentang ' . $tanggal_mulai . ' s/d ' . $tanggal_akhir);
